...
- 다른거 하지 말고 최우선 순위
	- [ ] 프로그래머스 레벨2 풀기
	- [ ] 프로그래머스 레벨3 풀기
	- [ ] 프로그래머스 레벨2 다시 풀기. 한번에 안풀리는 문제 기록
	- [ ] 프로그래머스 레벨3 다시 풀기. 한번에 안풀리는 문제 기록
	- [ ] 한번에 안 풀린 문제 또 다시 풀기. 한번에 안풀리는 문제 기록
	- [ ] 한번에 안 풀린 문제 또 다시 풀기.
	- [ ] 프로그래머스 레벨4 풀기
...
### 상황별 공부법
- 평소
    - 프로그래머스 레벨2, 레벨3은 현재 169문제. 그냥 이 169문제를 완전히 머리속에 넣고 그 이후를 욕심내자
